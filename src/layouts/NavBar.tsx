...
const NavBar = () => {
  return (
    <Disclosure as="nav" className="sticky top-0 bg-[#e62d3c]">
      {({ open }) => (
        <>
          <div className=" mb-10 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-white hover:bg-red-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                        ...
                        <Link
                          ...
                          className={classNames(
                            isActive
                              ...
                              : "text-black-300 hover:bg-red-700 hover:text-white",
              ...
              </div>
              {
                ...
                <button
                  type="button"
                  className="rounded-full bg-[#e62d3c] p-1 text-black hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
                >
